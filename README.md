...
<blockquote>
  <p>:warning: <strong>Important Notice:</strong>: The ```wmh_synthseg model``` has already been trained and is ready for use. However, please note that integration with FreeSurfer is currently in progress and not yet available. Stay tuned for updates on this implementation.</p>
</blockquote>
